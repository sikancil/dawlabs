    ...
    steps:
      ...
      - name: Oracle Intelligence Analysis
        ...
        run: |
          ...
          echo ""
          echo "📦 Oracle Intelligence Analysis Summary:"
          if [ -s oracle-intelligence-analysis.json ]; then
            ...
            echo "⚠️  Analysis completed but no JSON data captured"
          fi
