  ...
  release:
    ...
    steps:
      ...
      - name: Oracle Intelligence Analysis
        id: intelligence
        run: |
          node tools/internal-cli/index.js intelligent-analysis --json > oracle-intelligence-analysis.json 2>&1 || echo "Analysis completed with conflicts (expected for published packages)"

      # Display Oracle Intelligence analysis results
      - name: Display Oracle Intelligence Analysis
        if: always()
        run: |
          echo "🧠 Oracle Intelligence Analysis Results:"
